		...
		<div class="global-width">
			...
			<div class="action">
				...
				<form id="form1" name="form1" method="post"
					action="leaveExaminationAction.action" onsubmit="return check()">
